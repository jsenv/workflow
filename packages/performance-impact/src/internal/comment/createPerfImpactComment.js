import { renderGroupImpactTable } from "./renderGroupImpactTable.js";
...
<p>Impact on ${metricCount} metrics when merging <em>${pullRequestHead}</em> into <em>${pullRequestBase}</em>. Before drawing conclusion, keep in mind <a href="https://github.com/jsenv/workflow/tree/main/packages/performance-impact#performance-variability">performance variability</a>.</p>
